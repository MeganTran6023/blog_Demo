...
For the robotics project I was on, I was assigned to work on [OpenCV](https://github.com/opencv/opencv), a Computer Vision python package. To get my hands dirty with this, I tinkered around with the [MediaPipe](https://github.com/google-ai-edge/mediapipe/blob/master/docs/getting_started/python.md) framework – essentially this maps different joints and ligaments on a person's hand while they move and outputs the camera screen on a computer.

**What I got out of this**: I wanted my game to track a person's movement in real-time.

## Research Project

This project actually blew my mind! I thought it would be cool to be a test subject to try out a project my principal investigator was working on - the [Gamified Physical Therapy Rehabilitation System](https://usf.technologypublisher.com/technology/57518). Essentially, you contol a game character to dodge obstacles by flexing your calf muscles. Think of this like Flappy Bird except it makes your legs stronger.
